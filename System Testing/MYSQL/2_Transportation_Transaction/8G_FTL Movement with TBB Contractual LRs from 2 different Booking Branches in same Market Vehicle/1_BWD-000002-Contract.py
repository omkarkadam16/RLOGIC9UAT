    ...
    def test_Contract_Master(self):
        ...
        if self.switch_frames("btn_NewRecord"):
            ...
            if self.switch_frames("OrganizationId"):
                ...
                self.send_keys(By.ID, "ToDate", "07-06-2025")
                ...
                series = [
                    {"Rate": "700", "MinimumValue": "700", "FromLocation": "BHIWANDI"},
                ...
                for i in series:
                    ...
                    if self.switch_frames("FormBookingType"):
                        ...
                        self.autocomplete_select(
                            By.ID, "FormFromLocation-select", i["FromLocation"]
                        )
                        self.autocomplete_select(
                        ...
                        self.click_element(
                            By.ID, "btnSave-ContractChargeHeadSession674"
                        )
                        time.sleep(2)
